...
export default function Card({ icon: Icon, title, description, href }: CardProps) {
    return (
        <Link href={href} className="block h-full">
            <div className="flex flex-col items-start gap-4 rounded-2xl bg-rose-50 p-8 shadow-sm hover:shadow-md cursor-pointer transition h-full min-h-[200px] animate-fadeInFromTop">
